...
public class RamzanShabe19DataSource {
    ...
    public RamzanShabe19DataSource(Context context) {
    ...
    public ArrayList<Dua> getList() {
        ...
        try {
            ...
            if (arrayListSqllite != null && arrayListSqllite.size() > 0) {
                ...
                arrayListLiveData = duaParser.getParseDua(C.RamzanShabe19aAmal);
                deleteAll();
    ...
    public ArrayList<Dua> getListFromSQLite() {
        ...
        try {
            Cursor mcursor = msqLiteDatabase.rawQuery(RamzanShabe19Contract.SQL_SELECT_ALL, null);
            while (mcursor.moveToNext()) {
                Dua dua = new Dua();
                dua.setDua_arabic_part(mcursor.getString(mcursor.getColumnIndex(RamzanShabe19Contract.RamzanShabe19Entry.COLUMN_NAME_ARABIC_PART)));
                dua.setDua_urdu_part(mcursor.getString(mcursor.getColumnIndex(RamzanShabe19Contract.RamzanShabe19Entry.COLUMN_NAME_URDU_PART)));
                arrayList.add(dua);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public long insert(Dua dua) {
        ...
        try {
            ...
            contentValues.put(RamzanShabe19Contract.RamzanShabe19Entry.COLUMN_NAME_ARABIC_PART, dua.getDua_arabic_part());
            contentValues.put(RamzanShabe19Contract.RamzanShabe19Entry.COLUMN_NAME_URDU_PART, dua.getDua_urdu_part());
            result = msqLiteDatabase.insert(RamzanShabe19Contract.RamzanShabe19Entry.TABLE_NAME, null, contentValues);
    ...
    public long deleteAll() {
        try {
            msqLiteDatabase.execSQL(RamzanShabe19Contract.SQL_DELETE_ALL);
