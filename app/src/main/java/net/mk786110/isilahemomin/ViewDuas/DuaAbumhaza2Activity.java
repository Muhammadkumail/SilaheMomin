...
import net.mk786110.isilahemomin.Datasource.DuaIAbuHamza2DataSource;
    ...
    private class get_data_AsynchTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            if (connectionError.length() != 0) {
                Toast.makeText(DuaAbumhaza2Activity. this, connectionError, Toast.LENGTH_SHORT).show();
            } else {
                mlistViewDua = (ListView) findViewById(R.id.detail_listview);
                TextView mtextView = (TextView) findViewById(R.id.detail_textview);

                SilaheMominAdaptor mDuaAbuHamza2Adaptor = new SilaheMominAdaptor(context, R.layout.activity_row, arrayList);
