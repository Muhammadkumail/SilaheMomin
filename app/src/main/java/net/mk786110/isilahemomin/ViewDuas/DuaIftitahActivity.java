...
import net.mk786110.isilahemomin.Datasource.DuaIftitahDataSource;
import net.mk786110.isilahemomin.Model.Dua;
import net.mk786110.isilahemomin.R;

import java.util.ArrayList;

public class DuaIftitahActivity extends AppCompatActivity {
    DuaIftitahDataSource mduaIftitahDataSource;
...
//    }
    ...
    private class get_data_AsynchTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            arrayList = mduaIftitahDataSource.getList();
            if(arrayList.size()==0)
            {
        ...
        protected void onPostExecute(Void aVoid) {
            if (connectionError.length() != 0) {
                Toast.makeText(DuaIftitahActivity.this, connectionError, Toast.LENGTH_SHORT).show();
            } else {
            ...
            mlistViewDua.setAdapter(mduaIftitahAdaptor);
