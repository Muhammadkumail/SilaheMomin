...
import net.mk786110.isilahemomin.Datasource.RajabMushtarekaAmalDataSource;
    ...
    private class get_data_AsynchTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            if (connectionError.length() != 0) {
                ...
                SilaheMominAdaptor mRajabMushtarekaAmaltAdaptor = new SilaheMominAdaptor(context, R.layout.activity_row, arrayList);
