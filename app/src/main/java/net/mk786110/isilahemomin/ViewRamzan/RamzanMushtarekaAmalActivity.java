package net.mk786110.isilahemomin.ViewRamzan;
...
import net.mk786110.isilahemomin.Datasource.RamzanMushtarekaAmalDataSource;
...
/*
    ...
    private class get_data_AsynchTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            progressDialog= ProgressDialog.show(RamzanMushtarekaAmalActivity.this, "wait", C.Salwat, true);
            progressDialog.setCancelable(true);
            progressDialog.setOnCancelListener(cancelListener);
            bCancelled=false;
            arrayList = new ArrayList<>();
            mRamzanMushtarekaAmalDataSource = new RamzanMushtarekaAmalDataSource(context);
            super.onPreExecute();
        }
        ...
        protected void onPostExecute(Void aVoid) {
            if (connectionError.length() != 0) {
                ...
                SilaheMominAdaptor mRamzanMushtarekaAmalAdaptor = new SilaheMominAdaptor(context, R.layout.activity_row, arrayList);
