package net.mk786110.isilahemomin.ViewSurahs;
...
import net.mk786110.isilahemomin.Datasource.SurahAnkabutDataSource;
    ...
    private class get_data_AsynchTask extends AsyncTask<Void,Void,Void>
    {
        ...
        protected void onPostExecute(Void aVoid) {
            if (connectionError.length() != 0) {
                Toast.makeText(SurahAnkabutActivity.this, connectionError, Toast.LENGTH_SHORT).show();
            } else {
            mlistViewDua=(ListView)findViewById(R.id.detail_listview);
            TextView mtextView=(TextView) findViewById(R.id.detail_textview);

                SilaheMominAdaptor mduaAnkabutAdaptor=new SilaheMominAdaptor(context,R.layout.activity_row, arrayList);
