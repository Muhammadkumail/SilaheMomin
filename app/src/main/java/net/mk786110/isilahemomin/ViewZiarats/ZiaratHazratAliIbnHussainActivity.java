...
import net.mk786110.isilahemomin.Datasource.ZiaratHazratAliIbnHussainSource;
    ...
    private class get_data_AsynchTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            TextView mtextView = (TextView) findViewById(R.id.detail_textview);
                ...
                SilaheMominAdaptor mziaratHazratAliIbnHussainAdaptor = new SilaheMominAdaptor(context, R.layout.activity_row, arrayList);
